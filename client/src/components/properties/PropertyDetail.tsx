...
// Define Job interface to handle both API and mock jobs
interface Job {
  id: string;
  title: string;
  status: string;
...
export function PropertyDetail({ property, onClose }: PropertyDetailProps) {
  ...
  const jobHistory: Job[] = property.jobs || [
    {
      id: "job-1",
      date: "2023-06-15",
  ...
  // Get property name from address if not available
